...
function ua_PaisAsesor() {
    try {
        alert("Entro Movil  pais asesor Change");
...
function ua_EstadoAsesor(){
    try {
       alert("Entro Movil estado asesor Change");
...
function ua_Estado() {
    try {
        alert("Entro Movil EstadoChange");
...
function ua_DelgMun() {
    try {
          alert("Entro MOvil Delegacion Change");
...
function ua_Colegios() {
    try {
       alert("Entro Movil Colegios Change");
...
function ua_ColegiosAsesor() {
    try {
       alert("Entro Movil Colegiosasesor Change");
...
function ua_Colegios2() {
    try {
      // alert("Entro Movil Colegios 2 Change");
