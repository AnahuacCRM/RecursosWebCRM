function ua_ProgramaDesc() {
    try {
       // alert("entro Programa DEsc");
        if(Xrm.Page.getAttribute("ua_codigo_del_programa").getValue() != null){
        //var Programa = Xrm.Page.getAttribute("ua_programa").getValue();

        var programaDesc = Xrm.Page.getAttribute("ua_codigo_del_programa").getValue();
...
function ua_ProgramaDescMovil() {
    try {
      // alert("entro Programa DEsc Movil");
        //var Programa = Xrm.Page.getAttribute("ua_programa").getValue();
       if(Xrm.Page.getAttribute("ua_programas_por_campus_asesor").getValue() != null){
        var programaDesc = Xrm.Page.getAttribute("ua_programas_por_campus_asesor").getValue();
        if(programaDesc != null){
